CLASS /dmo/cx_flight_legacy01 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_01',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_01',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id01 OPTIONAL
        booking_id            TYPE /dmo/booking_id01 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id01 OPTIONAL
        agency_id             TYPE /dmo/agency_id01 OPTIONAL
        customer_id           TYPE /dmo/customer_id01 OPTIONAL
        carrier_id            TYPE /dmo/carrier01-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_01-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_01-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date01 OPTIONAL
        end_date              TYPE /dmo/end_date01 OPTIONAL
        booking_date          TYPE /dmo/booking_date01 OPTIONAL
        flight_date           TYPE /dmo/flight_date01 OPTIONAL
        status                TYPE /dmo/travel_status01 OPTIONAL
        currency_code         TYPE /dmo/currency_code01 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id01,
          mv_booking_id            TYPE /dmo/booking_id01,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id01,
          mv_agency_id             TYPE /dmo/agency_id01,
          mv_customer_id           TYPE /dmo/customer_id01,
          mv_carrier_id            TYPE /dmo/carrier01-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_01-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_01-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date01,
          mv_end_date              TYPE /dmo/end_date01,
          mv_booking_date          TYPE /dmo/booking_date01,
          mv_flight_date           TYPE /dmo/flight_date01,
          mv_status                TYPE /dmo/travel_status01,
          mv_currency_code         TYPE /dmo/currency_code01,
...
CLASS /dmo/cx_flight_legacy01 IMPLEMENTATION.
